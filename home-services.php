			...
			<div class="news-grids">
				...
				<div class="col-md-4 news-grid wow fadeInLeft animated animated" data-wow-delay="0.4s" style="visibility: visible;margin-bottom:20px;">
					<a href="<?php echo esc_url($theme_options['service_link_'.$i]); ?>">
						<div class="to" style="padding: 48px 44px;background-color: #fff;box-shadow: rgba(51, 51, 51, 0.49) 0px 6px 17px;border-radius: 5%;position: relative;bottom:0;-webkit-transition: 0.3s;-o-transition: 0.3s;transition: 0.3s;">
