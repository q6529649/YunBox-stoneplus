...
class kadima_nav_new_walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= '<a'. $attributes .'>';
		$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
		$item_output .= ($args->has_children) ? '<i><img src="//stoneplus.site.yunclever.com/wp-content/themes/kadima/images/4-aboutus.png" alt=""></i><i class="fa fa-angle-down"></i></a>' : '<i><img src="//stoneplus.site.yunclever.com/wp-content/themes/kadima/images/4-aboutus.png" alt=""></i></a>';
		$item_output .= $args->after;
